...
{{--                    <h2 class="text-3xl font-bold tracking-tight text-gray-900">CONTACT BLOCK</h2>--}}
...
{{--                    <dl class="mt-10 space-y-4 text-base leading-7 text-gray-600">--}}
                    <dl class="space-y-4 text-base leading-7 text-gray-600">
                        ...
                        <div class="flex gap-x-4">
                            ...
                            <dd><a class="hover:text-gray-900" href="tel:+1 (123) 456-7890">+44 (123) 456-7890</a></dd>
                        </div>
                        <div class="flex gap-x-4">
                            <dt class="flex-none">
                            ...
                            <dd><a class="hover:text-gray-900" href="mailto:elliotstouch@yahoo.com">elliotstouch@yahoo.com</a></dd>
                        </div>
                    </dl>
                </div>
            </div>
