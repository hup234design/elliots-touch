...
{{--<div class="h-48 bg-gray-100 border-2 border-gray-400 flex items-center justify-center">--}}
{{--    <span>cta.index</span>--}}
{{--</div>--}}

<div class="px-6 py-12 sm:px-6 sm:py-24 lg:px-8">
    <div class="mx-auto max-w-2xl text-center">
        <h2 class="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">CALL TO ACTION BLOCK</h2>
