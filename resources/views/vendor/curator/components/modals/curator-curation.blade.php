            ...
            <div class="flex-1 overflow-hidden">
                <div class="flex flex-col h-full overflow-y-auto">
                    ...
                    <div class="flex-1 overflow-auto px-4 pb-4">
                        <div class="space-y-3">
                            <div x-show="presets" x-cloak>
                                <x-curator::curation-select
                                    ...
                                    name="preset"
                                    x-model="preset"
                                    x-on:change="$event.target.value && $event.target.value != 'custom'
                                    ? cropper.setAspectRatio( presets.find(p => p.key === $event.target.value).width / presets.find(p => p.key === $event.target.value).height )
                        ...
                        <div x-show="preset == 'custom'" class="flex items-center w-full mt-3">
                            <x-filament::button
                                type="button"
                                size="sm"
                                color="gray"
