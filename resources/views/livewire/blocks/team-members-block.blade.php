            ...
            <div class="grid grid-cols-1 gap-12 sm:grid-cols-2 md:gap-20">
                <div class="space-y-4 lg:flex lg:gap-6 lg:space-y-0">
                    <div class="flex-none lg:w-2/5">
                        <img
                            src="https://cdn.tailkit.com/media/placeholders/avatar-nHoaFkrJEx4-640x800.jpg"
                            alt="User Avatar"
                            class="shadow"
                        />
                    </div>
                    <div>
                        ...
                        <div class="mb-3 space-x-1">
                            ...
                            <a
                                href="javascript:void(0)"
                                class="text-gray-400 hover:text-[#333]"
                            >
                                <svg
                                    fill="currentColor"
                                    viewBox="0 0 24 24"
                            ...
                            <a
                                href="javascript:void(0)"
                                class="text-gray-400 hover:text-[#ea4c89]"
                            >
                                <svg
                                    fill="currentColor"
                                    viewBox="0 0 24 24"
                        ...
                        <p class="text-sm leading-relaxed text-gray-600 dark:text-gray-400">
                            Nam commodo turpis id lectus scelerisque vulputate. Integer sed
                            dolor erat. Fusce erat ipsum, varius vel euismod sed, tristique et
                            lectus.
                        </p>
                    </div>
                </div>
                <div class="space-y-4 lg:flex lg:gap-6 lg:space-y-0">
                    <div class="flex-none lg:w-2/5">
                        <img
                            src="https://cdn.tailkit.com/media/placeholders/avatar-Nm70URdtf3c-640x800.jpg"
                            alt="User Avatar"
                            class="shadow"
                        />
                    </div>
                ...
                <div class="space-y-4 lg:flex lg:gap-6 lg:space-y-0">
                    <div class="flex-none lg:w-2/5">
                        <img
                            src="https://cdn.tailkit.com/media/placeholders/avatar-mEZ3PoFGs_k-640x800.jpg"
                            alt="User Avatar"
                            class="shadow"
                        />
                    </div>
                ...
                <div class="space-y-4 lg:flex lg:gap-6 lg:space-y-0">
                    <div class="flex-none lg:w-2/5">
                        <img
                            src="https://cdn.tailkit.com/media/placeholders/avatar-sibVwORYqs0-640x800.jpg"
                            alt="User Avatar"
                            class="shadow"
                        />
                    </div>
                ...
                <div class="space-y-4 lg:flex lg:gap-6 lg:space-y-0">
                    <div class="flex-none lg:w-2/5">
                        <img
                            src="https://cdn.tailkit.com/media/placeholders/avatar-euZ2n8dGUcQ-640x800.jpg"
                            alt="User Avatar"
                            class="shadow"
                        />
                    </div>
                ...
                <div class="space-y-4 lg:flex lg:gap-6 lg:space-y-0">
                    <div class="flex-none lg:w-2/5">
                        <img
                            src="https://cdn.tailkit.com/media/placeholders/avatar-DLKR_x3T_7s-640x800.jpg"
                            alt="User Avatar"
                            class="shadow"
                        />
                    </div>
