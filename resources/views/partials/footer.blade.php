        ...
        <div class="space-y-4">
            <nav class="space-x-4">
                @if ($settings->social_facebook)
                    <a href="{{ $settings->social_facebook }}" target="_blank" class="text-gray-400 hover:text-[#1877f2]">
                ...
                @if ($settings->social_twitter)
                    <a href="{{ $settings->social_twitter }}" target="_blank" class="text-gray-400 hover:text-gray-800">
            ...
            <nav class="space-x-2 sm:space-x-8">
                ...
                @foreach ($footerMenu ?? [] as $menuItem)
                    @if ($menuItem['route'])
                        <a class="font-medium text-gray-700 hover:text-gray-950"
            ...
            <div x-data="{}" class="py-4">
                <a type="button" @click="$dispatch('open-modal', {id: 'mailchimp-signup'})"
                    class=" rounded-xl font-semibold text-white shadow-sm focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 bg-et-skyblue hover:bg-et-skyblue-700 focus-visible:outline-et-skyblue-700 px-5 py-2.5 text-md hover:cursor-pointer">
