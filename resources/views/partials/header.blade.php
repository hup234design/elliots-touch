<header x-data="{ mobileMenuOpen: false }">
    <div class="mt-4 container flex justify-between items-center">
        ...
        <div class="pr-8 md:px-8 md:mx-auto">
            <a href={{ route('pages.home') }}>
                <img src="{{ asset('logos/logo-transparent.png') }}" alt="Logo" class="max-h-12 w-auto md:max-h-16">
            </a>
        </div>
        ...
        <div class="md:hidden">
            ...
            >
                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 fill-current"  viewBox="0 0 24 24"><path d="M24 6h-24v-4h24v4zm0 4h-24v4h24v-4zm0 8h-24v4h24v-4z"/></svg>
            </button>
        </div>
        <!-- Menu Button END -->
    </div>
