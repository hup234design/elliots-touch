<header x-data="{ mobileMenuOpen: false }">
    <div class="mt-4 container flex justify-between items-center">
        <div class="hidden lg:flex-1 lg:flex gap-4">
        ...
        <div class="px-8 lg:mx-auto">
            <a href={{ route('pages.home') }}>
                <img src="{{ asset('logos/logo-transparent.png') }}" alt="Logo" class="max-h-16 w-auto">
            </a>
        </div>
        <div class="hidden text-right lg:block lg:flex-1">
        ...
        <div class="p-4 lg:hidden">
            ...
            >
                <x-heroicon-s-bars-3 class="h-10 w-10" />
            </button>
        </div>
        <!-- Menu Button END -->
    </div>
    ...
    >
            ...
            <ul class="flex flex-col justify-between items-center text-center gap-4">
                ...
                @foreach( $headerMenu ?? [] as $menuItem)
                    @if( $menuItem['route'])
                        <li class="px-4">
                            <a
                                class="font-black text-lg text-et-blue"
                                href="{{ route($menuItem['route'], $menuItem['slug']) }}">
                                {{ $menuItem['title'] }}
                            </a>
                        </li>
        ...
        <button
            ...
            class="absolute top-0 right-0 m-4 text-et-blue focus:outline-none focus:ring-2 focus:ring-gray-500"
        >
