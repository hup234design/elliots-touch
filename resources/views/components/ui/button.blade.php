...
<button
    ...
    {{ $attributes->class([
        ...
        'border-blue-700 bg-blue-700 text-white hover:border-blue-600    hover:bg-blue-600   focus:ring-blue-400/50 active:border-blue-700' => $color === 'primary',
        'bg-blue-100 border-blue-200 text-blue-800 hover:border-blue-300 hover:text-blue-900 focus:ring-blue-300/25 active:border-blue-200' => $color === 'secondary',
