<x-cms-posts-layout>
    ...
    <x-cms::page-heading heading="Posts" />
...
{{--    <div class="relative aspect-square lg:aspect-auto lg:w-64 lg:shrink-0">--}}
{{--        @if($post->featured_image?->media )--}}
{{--            @if ($post->featured_image->media->hasCuration( $post->featured_image->curation ?? "" ))--}}
{{--                <x-curator-curation :media="$post->featured_image->media" :curation="$post->featured_image->curation" class="absolute inset-0 h-full w-full rounded-xl bg-gray-50 object-cover"/>--}}
{{--            @else--}}
{{--                <x-curator-glider--}}
{{--                    class="absolute inset-0 h-full w-full rounded-xl bg-gray-50 object-cover"--}}
...
{{--    <div>--}}
{{--        <div class="prose max-w-none flex items-center gap-x-4">--}}
{{--            <time datetime="2020-03-16" class="mt-0">--}}
{{--                {{ $post->publish_at->format('l M j, Y') }}--}}
{{--            </time>--}}
{{--            &nbsp;|&nbsp;--}}
{{--            <a href="{{ route('posts.category', $post->post_category->slug) }}" class="mt-0 relative z-10 no-underline">--}}
{{--                {{ $post->post_category->title }}--}}
{{--            </a>--}}
{{--        </div>--}}
{{--                                    <div class="group relative prose">--}}
{{--                                        <h3 class="mt-3 group-hover:text-gray-600">--}}
{{--                                            <a href="{{ route('posts.post', $post->slug) }}" class=" no-underline">--}}
...
{{--                    <article class="relative isolate flex flex-col gap-8 lg:flex-row">--}}
{{--                        <div class="relative aspect-video lg:aspect-none lg:w-64 lg:shrink-0">--}}
